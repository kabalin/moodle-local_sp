...
/**
 * Strings for component 'local_sp', language 'en'
 *
 * @package   local_sp
...
$string['systemrolesync'] = 'System role sync';
$string['systemrolesynccourse_desc'] = 'Course to use as role sync source. If selected None - feature is disabled.';
$string['systemrolesynccourserole'] = 'Course role to match';
$string['systemrolesynccourserole_desc'] = 'Users that have this role in the course be allocated a system role.';
$string['systemrolesynctargetrole'] = 'System role to allocate';
$string['systemrolesynctargetrole_desc'] = 'This role will be allocated to user at system context and user will also be confirmed.';
